...
class PortabilityTests(unittest.TestCase):
    ...
    def test_docs_include_antigravity_install_paths(self) -> None:
        ...
        self.assertNotIn("Run this once in " + "Power" + "Shell", install_text)
        self.assertIn("Both use this plugin folder", install_text)
        self.assertIn("plugins/cities2-mcp", install_text)
        self.assertIn("plugin.json", install_text)
        self.assertIn("rerun the same install commands", install_text)
