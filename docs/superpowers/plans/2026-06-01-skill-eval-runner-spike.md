...
- Create
  `evals/reports/2026-06-04-cities2-knowledge-runner-spike.md`:
...
```powershell
git add evals/README.md evals/reports/2026-06-04-cities2-knowledge-runner-spike.md tests/test_eval_docs.py docs/superpowers/plans/2026-06-01-skill-eval-runner-spike.md
