...
The Claude plugin vendors the Python MCP server, the bundled Cities: Skylines II Wiki corpus, the skill files, and the local project workflow templates. It can also read the user's installed game encyclopedia when Cities: Skylines II is available locally.
